...
class MockOllamaService:
    ...
    def create_mock_ollama_embeddings():
        ...
        mock_embeddings.embed_query.side_effect = (
            MockOllamaService.mock_embedding_response
        )
...
class MockChromaService:
    ...
    def mock_add_document(self, document_id: str, title: str, metadata: Dict = None):
        ...
        self.stored_embeddings[document_id] = MockOllamaService.mock_embedding_response(
            title
        )
        return True
...
class MockUserInterface:
    ...
    def mock_user_choice(self, options: List[str], allow_skip: bool = False):
        ...
        return SelectionResult.SELECTED, (
            options[0] if options else (SelectionResult.SKIPPED, None)
        )
