...
⚠️ **IMPORTANT: Your response MUST be a valid JSON object ONLY, without any surrounding text, explanations, or markdown formatting like ```json ... ```. Adhere strictly to the provided response schema.**
"""
...
- You **must select from the given list of task cards only.**
  ⚠️ Do not create or suggest new task cards.
"""
